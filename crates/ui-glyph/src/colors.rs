...
pub mod dark {
    ...
    pub const BG: Color = NEUTRAL_950;
    pub const BG_SUBTLE: Color = NEUTRAL_900;
    pub const SURFACE: Color = NEUTRAL_900;
    pub const SURFACE_2: Color = NEUTRAL_800;
    pub const SURFACE_3: Color = NEUTRAL_700;
    pub const BORDER: Color = NEUTRAL_800;
    pub const BORDER_STRONG: Color = NEUTRAL_700;
    pub const TEXT: Color = NEUTRAL_50;
    pub const TEXT_MUTED: Color = NEUTRAL_400;
    pub const TEXT_SUBTLE: Color = NEUTRAL_500;
    pub const TEXT_DISABLED: Color = NEUTRAL_600;
    pub const ACCENT: Color = BLUE_400;
    pub const ACCENT_HOVER: Color = BLUE_300;
    pub const ACCENT_FG: Color = NEUTRAL_950;
