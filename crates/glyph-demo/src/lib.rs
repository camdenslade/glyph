...
mod hot {
    use glyph_core::{Component, FontWeight, Theme, View, button, column, image, row, text, text_input};
    use glyph_hot::abi::GlyphSignalTable;
    ...
    glyph_hot::glyph_guest!(HotDemoApp);
}
