...
use platform_glyph::{App, WindowOpener};
use widgets_glyph::{Checkbox, Select, Toggle};
...
impl Component for Counter {
    fn render(&self, theme: &Theme) -> View {
        ...
        .bg(theme.surface)
        .radius(theme.radius)
        .shadow(core_glyph::Shadow::new(0.0, 1.0, 8.0, Color::rgba(0.0, 0.0, 0.0, 0.15)))
        .into()
    }
}
...
impl Component for NoteEditor {
    fn render(&self, theme: &Theme) -> View {
        ...
        .bg(theme.surface)
        .radius(theme.radius)
        .shadow(core_glyph::Shadow::new(0.0, 1.0, 8.0, Color::rgba(0.0, 0.0, 0.0, 0.1)))
        .into()
    }
}
